...
const EditClinicDialog = ({ open, setOpen, clinic, fetchClinics }) => {
    ...
    const handleSubmit = async (data) => {
        ...
        try {
            const response = await fetch(`/api/admin/clinic/${clinic?._id}`, {
                method: "PUT",
    ...
    useEffect(() => {
        if (clinic) {
            ...
            form.reset({
                ...
                clinicEmail: clinic?.email,
                clinicPhone: clinic?.phoneNumber,
                email: clinic?.clinicAdmin[0]?.email,
                ...clinic
            });
        }
    }, [clinic]);
